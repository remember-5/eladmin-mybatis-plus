 ...
 */
package com.admin.log.controller;
...
public class AdminLogController {
    ...
    public ResponseEntity<Object> getLogs(LogQueryCriteria criteria, Pageable pageable) {
        criteria.setLogType("INFO");
        return new ResponseEntity<>(logService.queryAll(criteria, Utils.convertPage(pageable)), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> getUserLogs(LogQueryCriteria criteria, Pageable pageable) {
        ...
        return new ResponseEntity<>(logService.queryAllByUser(criteria, Utils.convertPage(pageable)), HttpStatus.OK);
    }
