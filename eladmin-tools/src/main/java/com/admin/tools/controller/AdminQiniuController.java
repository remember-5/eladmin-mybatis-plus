...
public class AdminQiniuController {
    ...
    public ResponseEntity<Object> emailConfig(@Validated @RequestBody QiNiuConfigModel qiniuConfig) {
        log.info("AdminQiniuController::emailConfig");
    ...
    public ResponseEntity<Object> getRoles(QiniuQueryCriteria criteria, Pageable pageable) {
        ...
        return new ResponseEntity<>(qiNiuService.queryAll(criteria, page), HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> upload(@RequestParam MultipartFile file) {
        QiNiuContentModel qiniuContent = qiNiuService.upload(file, qiNiuService.find());
