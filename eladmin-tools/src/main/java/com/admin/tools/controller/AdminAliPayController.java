...
public class AdminAliPayController {
    ...
    @GetMapping
    public ResponseEntity<AlipayConfigModel> get() {
    ...
    @ApiOperation("配置支付宝")
    @PutMapping
    public ResponseEntity<Object> payConfig(@Validated @RequestBody AlipayConfigModel alipayConfig) {
        log.info("AdminAliPayController::payConfig");
    ...
    public ResponseEntity<String> toPayAsPc(@Validated @RequestBody TradeVo trade) throws Exception {
        AlipayConfigModel aliPay = alipayService.find();
