 ...
 */
package com.admin.system.quartz.controller;
...
public class AdminQuartzJobController {
    ...
    public ResponseEntity<Object> update(@Validated(QuartzJobModel.Update.class) @RequestBody QuartzJobModel resources) {
