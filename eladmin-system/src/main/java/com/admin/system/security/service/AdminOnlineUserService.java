...
public class AdminOnlineUserService {
     ...
     * 保存在线用户信息
     *
     * @param adminJwtUserDto /
     * @param token           /
     * @param request         /
     */
    public void save(AdminJwtUserDto adminJwtUserDto, String token, HttpServletRequest request) {
        String dept = adminJwtUserDto.getUser().getDept().getName();
        String ip = StringUtils.getIp(request);
        String browser = StringUtils.getBrowser(request);
        String address = StringUtils.getCityInfo(ip);
        OnlineUserDto onlineUserDto = null;
        try {
            onlineUserDto = new OnlineUserDto(adminJwtUserDto.getUsername(), adminJwtUserDto.getUser().getNickName(),
