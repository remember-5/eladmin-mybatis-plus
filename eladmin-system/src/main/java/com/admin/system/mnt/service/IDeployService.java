 ...
 * @date 2020年5月5日
 */
public interface IDeployService extends IService<DeployModel> {
     ...
     * @return
     */
    String serverReduction(DeployHistoryModel resources);

    /**
     * @param resources
     * @return
     */
    String stopServer(DeployModel resources);

    /**
     * @param resources
     * @return
     */
    String startServer(DeployModel resources);

    /**
     * @param resources
     * @return
     */
    String serverStatus(DeployModel resources);
     ...
     * @param resources
     */
    void update(DeployModel resources);

    /**
     * @param resources
     */
    void create(DeployModel resources);
